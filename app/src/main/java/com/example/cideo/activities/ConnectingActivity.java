package com.example.cideo.activities;
...
import com.example.cideo.R;
import com.example.cideo.databinding.ActivityConnectingBinding;
                                ...
                                public void onSuccess(Void unused) {
                                    database.getReference()
                                        ...
                                        public void onCancelled(@NonNull @NotNull DatabaseError error) {
                                            Toast.makeText(ConnectingActivity.this, "No One  Available ", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                }
                            });
